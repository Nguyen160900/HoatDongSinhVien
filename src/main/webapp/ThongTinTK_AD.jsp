						...
						<div class="media">
							<div class="row" style="width: 100%;">
								<div class="col-sm-4" style="display: flex; justify-content: center;">
									<img src="<% if (giangVien.getGioiTinh().contains("Nữ")){out.print("./resource/image/anh-nu.jpg");} else {out.print("./resource/image/anh-nam.jpg");} %>" style="width: 350px; height: auto;">
								</div>
								<div class="col-sm-8">
									<div class="media-body">
										...
										<hr>
										<p>
											Ngày sinh: <%= giangVien.getNgaySinh() %>
										</p>
										<p>
											Giới tính: <%= giangVien.getGioiTinh() %>
										</p>
										<p>
											Số điện thoại: <%= giangVien.getSDT() %>
										</p>
										<p>
